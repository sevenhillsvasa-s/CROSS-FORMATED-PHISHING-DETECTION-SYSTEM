...
Original file is located at
    https://colab.research.google.com/drive/1jdwE67JuANSasViRdTouzlhsvBrVzicz
"""
...
# --- Launch Tabs Interface ---
url_tab = gr.Interface(
    fn=url_interface,
    inputs=gr.Text(label="🔗 Enter URL to Scan"),
...
gr.TabbedInterface(
    [url_tab, file_tab],
    tab_names=["🔗 URL Scanner", "📂 File Scanner"]
).launch(debug=True)